...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	// avgSpeed - Средняя скорость бега в Км/ч
	avgSpeed := meanSpeed(action, duration)
	return ((runningCaloriesMeanSpeedMultiplier * avgSpeed * runningCaloriesMeanSpeedShift) *
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	// meanSpeedMsec - Средняя скорость в метрах в секунду
	// heightInM - Рост в метрах
	meanSpeedMSec := meanSpeed(action, duration) * kmhInMsec
	heightInM := height / cmInM
	return ((walkingCaloriesWeightMultiplier*weight + (math.Pow((meanSpeedMSec), 2)/(heightInM))*
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	// swimmingSpeed - Средняя скорость плавания в Км/ч
	swimmingSpeed := swimmingMeanSpeed(lengthPool, countPool, duration)
	return (swimmingSpeed + swimmingCaloriesMeanSpeedShift) * 2 * weight * duration
}
